...
@Component({
  ...
  styleUrls: ['./goals-report.component.scss']
})
export class GoalsReportComponent {
  ...
  groupByOptions = [
    ...
    { key: 'goalName', label: 'Goal Name', checked: true },
  ...
  metricsOptions = [
    ...
    { key: 'grossClicks', label: 'Gross Clicks', checked: false },
  ...
  reportData = [
    { goalName: 'Registration', goalId: 'G001', campaign: 'Spingranny', approvedConversions: 45, payout: 450.00, revenue: 590.00, profit: 140.00 },
    { goalName: 'First Deposit', goalId: 'G002', campaign: 'Winner Casino', approvedConversions: 28, payout: 560.00, revenue: 735.00, profit: 175.00 },
    { goalName: 'Qualified Lead', goalId: 'G003', campaign: 'Bet O Bet', approvedConversions: 62, payout: 310.00, revenue: 408.00, profit: 98.00 },
    { goalName: 'Purchase', goalId: 'G004', campaign: 'Play Ojo', approvedConversions: 15, payout: 750.00, revenue: 985.00, profit: 235.00 },
    { goalName: 'App Install', goalId: 'G005', campaign: 'Monster Casino', approvedConversions: 89, payout: 178.00, revenue: 234.00, profit: 56.00 }
  ];

  savedReportsList = [{ value: '', label: '--' }, { value: 'report1', label: 'Weekly Goals Overview' }];
  ...
  get filteredData() {
    ...
    return this.reportData.filter(item => item.goalName.toLowerCase().includes(this.searchQuery.toLowerCase()));
  }
